...
import static data.DataEnum.GOOGLE_LINK;
import static data.DataEnum.GOOGLE_SEARCH_TEXT;
...
public class WebMobileTests extends BaseTest {
  ...
  @Test(groups = {
      "web"}, description = "go to a Google search page and make a search using keyword ‘EPAM’. Make sure that there should be some relevant results")
